...
namespace OpenGGF.BizHawk.Headless.Tests
{
    internal static class S2RequestAwareOracleV2ExtractorTests
    {
        ...
        private static void AcceptCommittedUnboundCandidateTemplate()
        {
            ...
            // The request marker lives in the observer patch itself, and the
            // selftest that proves its boundary stands in for the old
            // candidate recipe.
            AssertEx.Equal(Digest(File.ReadAllBytes(Path.Combine(
                EndToEndTests.ToolDirectory,"native","gpgx-audio-observer",
