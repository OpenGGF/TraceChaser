...
namespace OpenGGF.BizHawk.Headless.Tests
{
    ...
    internal static class TestMain
    {
        ...
        internal static List<TestCase> BuildRegistry()
        {
            ...
            PreflightRunnerContractTests.Register(tests);
            ...
            RegisterSerial(tests, S3kAudioObserverProfileTests.Register);
            RegisterSerial(tests, S3kCompleteAudioCaptureRunnerTests.Register);
            RegisterSerial(tests, S3kCompleteAudioRawSinkTests.Register);
            RegisterSerial(tests, S3kPreconsumptionRequestProfileTests.Register);
            RegisterSerial(tests, S3kSubmissionAudioRawV2Tests.Register);
