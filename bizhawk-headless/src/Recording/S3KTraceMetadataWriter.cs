...
namespace OpenGGF.BizHawk.Headless
{
    ...
    /// were regenerated by Lua v6.31-s3k it is now the ONLY permitted
    /// metadata delta against them: the version strings match, and MGZ's
    /// leftover pre_trace_osc_frames line (dropped in v6.29) is gone from
    /// the regenerated fixture — spec §6.2 pins that exactly.
    /// </summary>
    public static class S3KTraceMetadataWriter
    {
        public const string LuaScriptVersion = "6.31-s3k";
