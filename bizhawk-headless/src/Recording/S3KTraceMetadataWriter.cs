...
namespace OpenGGF.BizHawk.Headless
{
    ...
    /// write_metadata) and advanced to v6.41-s3k for state-proven
    /// held-counter module POST attribution under trace schema 7 / hardware
    ...
    /// only permitted metadata deltas against them are the reviewed version
    /// migration and recording date. MGZ's leftover pre_trace_osc_frames
    /// line (dropped in v6.29) is gone from the regenerated fixture — spec
    /// §6.2 pins that exactly.
    /// </summary>
