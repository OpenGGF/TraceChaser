...
rather than treating it as the publisher. It provides optional differential
evidence for recorder changes and remains the substrate for ad-hoc hook-driven
debugging (see below).
